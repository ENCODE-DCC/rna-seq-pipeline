...
class TestMergeAnnotation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fasta_string_with_stuff_in_left = ' 1\tgg\n >NAME\nATTC\n>NAME2\nCACACA\n\n\n'
        self.fasta_string = '>NAME\nATTC\n>NAME2\nCACACA\n\n\n'

    def test_replace_on_good_line(self):
        self.assertEqual(
            merge_annotation.replace_nth_position_with(self.good_tRNA_line, 2,
                                                       'exon', '\t'),
    ...
    def test_replace_on_empty_line(self):
        self.assertRaises(IndexError,
                          ...
                          self.empty_string, 2, 'replacement', ' ')

    def test_replace_on_bad_line(self):
        self.assertRaises(IndexError,
                          merge_annotation.replace_nth_position_with,
                          self.bad_tRNA_line, 2, 'replacement', '\t')

    def test_replace_nochange(self):
        self.assertEqual(self.unchanged_string,
                         merge_annotation.replace_nth_position_with(
    ...
    def test_get_fasta_tokens_empty(self):
        self.assertRaises(ValueError, merge_annotation.get_fasta_tokens,
                          self.empty_string)
    ...
    def test_remove_whitespace_empty(self):
        self.assertEqual(
            merge_annotation.remove_whitespace(self.empty_string),
            self.empty_string)
    ...
    def test_remove_whitespace_with_whitespace(self):
        self.assertEqual(
            merge_annotation.remove_whitespace('\taaa aaa\n '), 'aaaaaa')
